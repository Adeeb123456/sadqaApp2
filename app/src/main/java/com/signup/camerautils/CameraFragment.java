package com.signup.camerautils;
...
public class CameraFragment extends BaseFragment implements SurfaceHolder.Callback, Camera.PictureCallback {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            mFlashMode = AppPref.getStringByKey(AppConst.flashMode);
            if (mFlashMode.equalsIgnoreCase("")) {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        try {
            if (Camera.getNumberOfCameras() == 0) {
             //   showDialog(getString(R.string.camera_unavailable), AppConst.AlertType.ERROR);
                return;
...
//        MyDialog dialog = new MyDialog(getActivity(), null, alertType, msg);
    ...
    public void onStop() {
        ...
        AppPref.putValueByKey(AppConst.flashMode, mFlashMode);
...
//        Log.d(TAG, "Rotate Picture by: " + rotation);
        getFragmentManager()
                ...
                .replace(
                        ...
                        EditSavePhotoFragment.newInstance(data, rotation, mImageParameters.createCopy(), true, null),
